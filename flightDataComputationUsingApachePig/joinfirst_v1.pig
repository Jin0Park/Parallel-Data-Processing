...
f1f2YearMonthInRange = FILTER f1f2SameDateNoDivertNoCancelTwoLeg BY (f1::Year == 2007 AND f1::Month >= 6) OR (f1::Year == 2008 AND f1::Month <= 5) AND (f2::Year == 2007 AND f2::Month >= 6) OR (f2::Year == 2008 AND f2::Month <= 5);

f1f2ArrDelayMin = FOREACH f1f2YearMonthInRange GENERATE f1::FlightDate AS day, (f1::ArrDelayMinutes + f2::ArrDelayMinutes) AS delayMin;
...
STORE twoLegAvg INTO 's3://dominic-bucket/hw3/o2' USING PigStorage(',');